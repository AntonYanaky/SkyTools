        ...
        <div className='min-h-screen flex flex-col px-6 lg:px-12 bg-white dark:bg-black text-black dark:text-white'>
            ...
            <main className='flex-grow flex flex-col mt-8'>
                ...
                <div className="w-[14em] lg:w-[40vw] justify-center text-xl py-8 mx-auto">
                    ...
                    <p>SkyTools tracks real-time market prices from the Bazaar and Auction House to help you find the best bit flips, boost your profit, and stay ahead in the game! 📈💸</p>
                </div>
            </main>
            <Footer />
        </div>
